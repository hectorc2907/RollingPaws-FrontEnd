    ...
    <>
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route exact path="/administrador/crear-paciente" element={<CrearPaciente></CrearPaciente>}></Route>
          <Route exact path="/administrador/editar-paciente/:id" element={<EditarPaciente></EditarPaciente>}></Route>
          <Route exact path="/administrador/crear-turno" element={<CrearTurno></CrearTurno>}></Route>
          <Route exact path="/administrador/editar-turno/:id" element={<EditarTurno></EditarTurno>}></Route>
